...
<body style="background-image:url('image4.jpg'); no-repeat top; background-size:cover;">
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<input type="number" placeholder="Phone" name="phone" value="<?php echo $phone; ?>" required>
			</div>
			<div class="input-group">
