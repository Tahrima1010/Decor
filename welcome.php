                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4">
                        ...
                        <form method="post" action="welcome.php?action=add&id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="product">
                                <img src="<?php echo $row["image"]; ?>" class="img-responsive img1">
...
<a href="logout.php"><button class="btn" style="background-color: black;  font-weight:bold; font-size:20px;
  color: white; margin-left:1300px;" >Log Out</button></a>
  </div>
    </div>
<footer>
